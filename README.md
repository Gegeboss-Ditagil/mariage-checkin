...
[![Version](https://img.shields.io/badge/version-1.30.2-blue)](package.json)
...
- Branche de production : `main`; version proposée : **1.30.2**.
...
Voir `CHANGELOG.md` pour le détail de **v1.30.2** et l'historique des versions.
