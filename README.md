...
[![Version](https://img.shields.io/badge/version-1.31.0-blue)](package.json)
...
- Branche de production : `main`; version proposée : **1.31.0**.
...
- `/agenda` donne à Gersom, Nelly, l'admin et aux directeurs un chronogramme partagé : ajout d’activités entre deux étapes, modification directe de l'heure/titre/département/détails, affectation de responsables, validation « terminé » et mise à jour pour les autres appareils. Les migrations `0039_shared_agenda.sql` puis `0041_agenda_manager_access.sql` doivent être appliquées.
...
Voir `CHANGELOG.md` pour le détail de **v1.31.0** et l'historique des versions.
