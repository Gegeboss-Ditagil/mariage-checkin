...
- **Barre de navigation « verre liquide »** : capsule flottante inspirée du Dock iOS fourni en référence, avec flou/saturation renforcés, reflet intérieur, ombre profonde, tuiles arrondies de 44 px derrière les raccourcis et bouton central de 84 px. Les libellés restent visibles pour l'usage opérationnel. En orientation paysage (téléphone tourné, ou iPad), elle bascule en bande verticale fixée au bord droit de l'écran ; le contenu de la page défile normalement de haut en bas, indépendamment de la barre.
