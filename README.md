...
[![Version](https://img.shields.io/badge/version-1.30.1-blue)](package.json)
...
- Branche de production : `main`; version proposée : **1.30.1**.
...
Voir `CHANGELOG.md` pour le détail de **v1.30.1** et l'historique des versions.
