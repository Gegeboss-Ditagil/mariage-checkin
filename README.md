...
[![Version](https://img.shields.io/badge/version-1.15.3-blue)](package.json)
...
Voir `CHANGELOG.md` pour le détail de **v1.15.3** et l'historique des versions.
