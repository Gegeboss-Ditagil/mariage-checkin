...
[![Version](https://img.shields.io/badge/version-1.27.2-blue)](package.json)
...
Voir `CHANGELOG.md` pour le détail de **v1.27.2** et l'historique des versions.
