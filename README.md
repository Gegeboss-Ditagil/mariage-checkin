...
[![Version](https://img.shields.io/badge/version-1.23.0-blue)](package.json)
...
Voir `CHANGELOG.md` pour le détail de **v1.23.0** et l'historique des versions.
