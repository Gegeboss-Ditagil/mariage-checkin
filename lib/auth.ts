...
//
// Une session expire apres 12 h. Voir lib/sessionVersion.ts : un deploiement
// Vercel n'invalide plus les sessions actives (retire le 17/09/2026 -- c'etait
// la cause principale d'un signalement de deconnexions frequentes).
// ---------------------------------------------------------------------------
